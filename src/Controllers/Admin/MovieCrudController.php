...
namespace nguonc\Core\Controllers\Admin;

use nguonc\Core\Requests\MovieRequest;
 ...
 * @package nguonc\Core\Controllers\Admin
...
class MovieCrudController extends CrudController
{
    ...
    use \nguonc\Core\Traits\Operations\BulkDeleteOperation {
    ...
    {
        CRUD::setModel(\nguonc\Core\Models\Movie::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/movie');
        CRUD::setEntityNameStrings('movie', 'movies');
        CRUD::setCreateView('nguonc::movies.create',);
        CRUD::setUpdateView('nguonc::movies.edit',);
    }
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addFilter([
            ...
            if ($field === 'language') {
                ...
                $this->crud->query->where($field, '')->orWhere($field, NULL)->orWhere($field, 'like', '%img.nguonc%')->orWhere($field, 'like', '%img.hiephanhthienha%');
            }
        });
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'nguonc::movies.columns.column_movie_info',
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'nguonc::movies.inc.episode',
            'tab' => 'Danh sách tập phim'
        ],);

        CRUD::addField(['name' => 'update_handler', 'label' => 'Trình cập nhật', 'type' => 'select_from_array', 'options' => collect(config('nguonc.updaters', []))->pluck('name', 'handler')->toArray(), 'tab' => 'Cập nhật']);
