...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'nguonC CMS - Tạo website xem phim miễn phí vĩnh viễn',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('nguonc.version') .
                '</span><br/>
                Trang chủ: <a href="https:///phim.nguonc.com">nguon C</a><br/>
                Dữ liệu phim miễn phí: <a href="https:///phim.nguonc.com">Nguon C</a>
            ',
